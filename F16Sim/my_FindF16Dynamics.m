...
fi_flag_Simulink = 1;
[trim_state_hi, trim_thrust_hi, trim_control_hi, dLEF, xu_hi] = my_trim_F16(thrust, elevator, alpha, aileron, rudder, velocity, altitude);
...
fi_flag_Simulink = 0;
[trim_state_lo, trim_thrust_lo, trim_control_lo, dLEF, xu_lo] = my_trim_F16(thrust, elevator, alpha, aileron, rudder, velocity, altitude);
